                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ListTile(
                      ...
                      onTap: () async {
                        ...
                        final remainingList = itemsForSelectedDay.where((element) => 
              ...
              if (trainingDays.isEmpty)
                ...
                Column(
                  children: [
                    ...
                    if (showStartButton) ...[
                      const SizedBox(height: 16),
                      SizedBox(width: double.infinity, child: ElevatedButton.icon(onPressed: _startTodayWorkout, icon: const Icon(Icons.play_arrow), label: const Text('開始今日訓練'), style: ElevatedButton.styleFrom(backgroundColor: Colors.green, foregroundColor: Colors.white, padding: const EdgeInsets.symmetric(vertical: 12)))),
                    ],
                  ],
                ),
            ],
