...
import './create_post_page.dart'; // 【新增】導入發文頁面
      ...
      builder: (dialogContext) => AlertDialog(
        ...
        actions: [
          ...
          TextButton(
            child: const Text('儲存'),
            onPressed: () async {
              final updatedUser = _displayUser!.copyWith(nickname: nicknameController.text);
              await DatabaseHelper.instance.updateUser(updatedUser);
              await FirestoreService.instance.syncUserData(nickname: nicknameController.text);
              _loadDisplayUserData();
