...
// ... (existing code) ...
  ...
  Future<String> uploadUserImage(String uid, Uint8List fileData) async {
  ...
  Future<Map<String, List<String>>> getAllExercises() async {
    ...
    return {
      "胸部": ["槓鈴臥推", "啞鈴臥推", "上斜啞鈴臥推", "繩索夾胸", "伏地挺身", "雙槓撐體"],
      "背部": ["引體向上", "滑輪下拉", "槓鈴划船", "啞鈴划船", "直臂下壓", "硬舉"],
      "腿部": ["深蹲", "腿推舉", "弓箭步", "腿屈伸", "腿後勾", "小腿提踵"],
      "肩部": ["槓鈴肩推", "啞鈴肩推", "側平舉", "前平舉", "臉拉", "聳肩"],
      "手臂": ["二頭肌彎舉", "垂式彎舉", "三頭肌下壓", "法式彎舉", "窄距臥推"],
      "核心": ["卷腹", "平板支撐", "俄羅斯轉體", "懸垂舉腿", "滾輪"],
      "有氧": ["跑步", "腳踏車", "滑步機", "跳繩", "划船機"],
      "其他": ["波比跳", "壺鈴擺盪", "戰繩"]
    };
  }
