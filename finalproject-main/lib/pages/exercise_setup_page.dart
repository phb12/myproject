                    ...
                    if (ExerciseGuideHelper.getGuideImage(widget.exercise.name) != null)
                          ...
                          errorBuilder: (context, error, stackTrace) {
                            return const Center(
                              child: Column(
                                ...
                                children: [
                                  Icon(Icons.image_not_supported, color: Colors.black54, size: 50),
                                  SizedBox(height: 8),
                                  Text('圖片載入失敗', style: TextStyle(color: Colors.black54)),
                                ],
                              ),
                            );
                          },
                      ...
                      const Center(
                        child: Column(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            Icon(Icons.camera_alt_outlined, color: Colors.black54, size: 60),
                            SizedBox(height: 16),
                            Text(
                              '請參考下方說明架設相機',
