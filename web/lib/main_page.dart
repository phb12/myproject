    ...
    try {
      ...
      if (mounted) {
        setState(() {
          ...
          avatarUrl = "$url${separator}t=${DateTime.now().millisecondsSinceEpoch}";
    ...
    switch (selectedIndex) {
      case 0:
        currentPage = DashboardPage(
          ...
          displayName: displayNickname, // 🚨 Pass dynamic nickname
        );
        break;
      case 1:
        currentPage = TrainingSchedulePage(username: widget.username);
        break;
      case 2:
        ...
        break;
      case 3:
        currentPage = TrainingRecordPage(username: widget.username);
        break;
      case 4:
         currentPage = const VideoAnalysisPage();
         break;
      default:
        currentPage = DashboardPage(username: widget.username);
    }
